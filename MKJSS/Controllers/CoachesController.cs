...
namespace MKJSS.Controllers
{
    public class CoachesController : Controller
    {
        ...
        public CoachesController(MKJSSContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id")] Coach coach)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id")] Coach coach)
        {
            if (id != coach.Id)
            {
                return NotFound();
